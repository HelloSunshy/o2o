...
import com.sunshy.o2o.util.CodeUtil;
...
public class ProductManagementController {
    ...
    private Map<String, Object> getProductById(@RequestParam Long productId) {
        ...
        if (productId > -1) {
            ...
            List<ProductCategory> productCategoryList = productCategoryService
                    .queryProductCategoryByShopId(product.getShop().getShopId());
    ...
    private Map<String, Object> getProductCategoryListByShopId(
        ...
        if ((currentShop != null) && (currentShop.getShopId() != null)) {
            List<ProductCategory> productCategoryList = productCategoryService
                    .queryProductCategoryByShopId(currentShop.getShopId());
    ...
    private Map<String, Object> addProduct(HttpServletRequest request) {
        ...
        try {
            if (multipartResolver.isMultipart(request)) {
                ...
                thumbnail = (MultipartFile) multipartRequest.getFile("thumbnail");

                for (int i = 0; i < IMAGEMAXCOUNT; i++) {

                    MultipartFile productImg = (MultipartFile) multipartRequest.getFile("productImg" + i);
        ...
        if (product != null && thumbnail != null && productImgs.size() > 0) {
            try {
                ...
                if (pe.getState() == ProductStateEnum.SUCCESS.getStatue()) { modelMap.put("success", true);
                } else {
    ...
    private Map<String, Object> modifyProduct(HttpServletRequest request) {
        ...
        if (multipartResolver.isMultipart(request)) {
            ...
            thumbnail = (MultipartFile) multipartRequest
                    .getFile("thumbnail");

            for (int i = 0; i < IMAGEMAXCOUNT; i++) {

                MultipartFile productImg = (MultipartFile) multipartRequest
        ...
        if (product != null) {
            try {
                ...
                if (pe.getState() == ProductStateEnum.SUCCESS.getStatue()) {
                    modelMap.put("success", true);
                } else {
                    modelMap.put("success", false);
                    modelMap.put("errMsg", pe.getStateInfo());
